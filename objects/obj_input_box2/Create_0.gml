...
var _defaultArray = ["password",fnt_text,true];
var _hideArray = [true,"*",fnt_hide,font_get_size(fnt_hide)+8];
var _excludedArray = [";","!"];
input_box_init((room_width/2)+16,(room_height/2)-12,192,24,font_get_size(fnt_text)+7,false,_defaultArray,192-(4*3),30,6,fnt_text,1,_hideArray,0,_excludedArray,obj_dropdown_box);
