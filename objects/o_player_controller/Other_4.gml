if room == rm_game {
	...
	//instance_create_layer(172,260,"Instances", o_monster_controller)
	//instance_create_layer(x,y,"Instances", o_coin_spawn)
	//instance_create_layer(x,y,"Instances", o_quest_controll_update)
	//instance_create_layer(x,y,"Instances", o_secret_item_controller)
