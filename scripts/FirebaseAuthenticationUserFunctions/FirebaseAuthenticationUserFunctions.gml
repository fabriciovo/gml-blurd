...
#macro FirebaseAuthentication_Library_Only_SDKs "Only_SDKs"
#macro FirebaseAuthentication_Library_SDKs_When_Available "SDKs_When_Available"
#macro FirebaseAuthentication_Library_Only_REST_API "Only_REST_API"

#macro FirebaseAuthentication_Library_useSDK ((FirebaseAuthentication_Library == FirebaseAuthentication_Library_SDKs_When_Available and (os_type == os_android or os_type == os_ios or os_browser != browser_not_a_browser)) or FirebaseAuthentication_Library == FirebaseAuthentication_Library_Only_SDKs)
...
function FirebaseAuthentication_SignInWithCustomToken(token)
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		FirebaseAuthentication_endpoint + "signInWithCustomToken?key=" + Firebase_WebAPIKey,
		"POST",
...
function RESTFirebaseAuthentication_RequestIDToken(refresh_token)
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		Obj_FirebaseREST_Listener_Once_Authentication,
		"https://securetoken.googleapis.com/v1/token?key=" + Firebase_WebAPIKey,// THIS IS DIFFERENT!!!!
		"POST",
...
function FirebaseAuthentication_SignUp_Email(email,password)
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		Obj_FirebaseREST_Listener_Once_Authentication,
		FirebaseAuthentication_endpoint + "signUp?key=" + Firebase_WebAPIKey,
		"POST",
		FirebaseREST_KeyValue("Content-Type","application/json"),
...
function FirebaseAuthentication_SignIn_Email(email,password)
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		Obj_FirebaseREST_Listener_Once_Authentication,
		FirebaseAuthentication_endpoint + "signInWithPassword?key=" + Firebase_WebAPIKey,
		"POST",
		FirebaseREST_KeyValue("Content-Type","application/json"),
		FirebaseREST_KeyValue("returnSecureToken","true","email",email,"password",password)
		)
...
function FirebaseAuthentication_SignIn_GameCenter(bundle_id,playerId,publicKeyUrl,signature,salt,timestamp,idToken,displayName)
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		Obj_FirebaseREST_Listener_Once_Authentication,
		FirebaseAuthentication_endpoint + "signInWithGameCenter?key=" + Firebase_WebAPIKey,
		"POST",
...
function FirebaseAuthentication_SignIn_OAuth(token,token_kind,provider,requestUri = "")
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		Obj_FirebaseREST_Listener_Once_Authentication,
		FirebaseAuthentication_endpoint + "signInWithIdp?key=" + Firebase_WebAPIKey,
		"POST",
		FirebaseREST_KeyValue("Content-Type","application/json"),
...
/*function FirebaseAuthentication_Fetch_Providers(email,continueUri)
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		Obj_FirebaseREST_Listener_Once_Authentication,
		FirebaseAuthentication_endpoint + "createAuthUri?key=" + Firebase_WebAPIKey,
		"POST",
		FirebaseREST_KeyValue("Content-Type","application/json"),
...
function FirebaseAuthentication_SendPasswordResetEmail(email)
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		Obj_FirebaseREST_Listener_Once_Authentication,
		FirebaseAuthentication_endpoint + "sendOobCode?key=" + Firebase_WebAPIKey,
		"POST",
		FirebaseREST_KeyValue("Content-Type","application/json"),
...
/*function FirebaseAuthentication_VerifyPasswordResetCode(oobCode)
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		Obj_FirebaseREST_Listener_Once_Authentication,
		FirebaseAuthentication_endpoint + "resetPassword?key=" + Firebase_WebAPIKey,
		"POST",
		FirebaseREST_KeyValue("Content-Type","application/json"),
...
function FirebaseAuthentication_ChangeEmail(email)
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		Obj_FirebaseREST_Listener_Once_Authentication,
		FirebaseAuthentication_endpoint + "update?key=" + Firebase_WebAPIKey,
		"POST",
		FirebaseREST_KeyValue("Content-Type","application/json"),
...
function RESTFirebaseAuthentication_GetUserData()
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		Obj_FirebaseREST_Listener_Once_Authentication,
		FirebaseAuthentication_endpoint + "lookup?key=" + Firebase_WebAPIKey,
		"POST",
		FirebaseREST_KeyValue("Content-Type","application/json"),
...
function FirebaseAuthentication_DeleteAccount()
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		Obj_FirebaseREST_Listener_Once_Authentication,
		FirebaseAuthentication_endpoint + "delete?key=" + Firebase_WebAPIKey,
		"POST",
		FirebaseREST_KeyValue("Content-Type","application/json"),
		FirebaseREST_KeyValue("idToken",RESTFirebaseAuthentication_GetIdToken()),
...
function FirebaseAuthentication_RecaptchaParams()
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		Obj_FirebaseREST_Listener_Once_Authentication,
		"https://identitytoolkit.googleapis.com/v1/recaptchaParams?key=" + Firebase_WebAPIKey,
		"GET",
		FirebaseREST_KeyValue("Content-Type","application/json"),
		"",
...
function FirebaseAuthentication_SendVerificationCode(phoneNumber,recaptchaToken)
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		Obj_FirebaseREST_Listener_Once_Authentication,
		FirebaseAuthentication_endpoint + "sendVerificationCode?key=" + Firebase_WebAPIKey,
		"POST",
		FirebaseREST_KeyValue("Content-Type","application/json"),
...
function FirebaseAuthentication_SignInWithPhoneNumber(phoneNumber,code,sessionInfo)
{
	...
	var listener = FirebaseREST_asyncFunction_Authentication(
		...
		Obj_FirebaseREST_Listener_Once_Authentication,
		FirebaseAuthentication_endpoint + "signInWithPhoneNumber?key=" + Firebase_WebAPIKey,
		"POST",
		FirebaseREST_KeyValue("Content-Type","application/json"),
