...
function achivment_reward(_player_array, _reward, _achivment){
	var _array_achivments = o_player_controll.player.achievements
	var _name = _achivment.name
	var _sprite = _achivment.sprite
	...
	instance_create_layer(global.VW / 2,50,"Instances", o_achviment_ui, new achivment_ui(_name, _sprite))
}